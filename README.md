...
| `send_telegram_message` | Post text to the configured Telegram channel (`text` ≤ 4096 chars; optional `parse_mode` / `disable_notification`). Target is always `TELEGRAM_CHANNEL_ID`; bot must be a channel admin |
